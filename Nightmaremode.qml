...
SceneBase{
    ...
    property int gridSizeGame: 8 // game grid size in tiles
    ...
    Rectangle {
        z: -1
        anchors.fill: mode8x8.gameWindowAnchorItem
        ...
        if (isMoved) {
            ...
            if(emptyCells.length === 0)
            {
                if(checkIfFail())
                {
                    ...
                    scoreScene.score = mode8x8.score
                    window.previousScene = "nightmare"
                }
            }
        }
    }
